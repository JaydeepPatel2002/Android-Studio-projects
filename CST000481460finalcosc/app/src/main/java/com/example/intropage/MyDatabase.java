...
public class MyDatabase {
    ...
    public MyDatabase(Context appContext) {
    ...
    public ArrayList<Pizza> getListObject(String key){
        Gson gson = new Gson();

        ArrayList<String> objStrings = getListString(key);
        ArrayList<Pizza> playerList =  new ArrayList<Pizza>();

        for(String jObjString : objStrings){
            Pizza player  = gson.fromJson(jObjString,  Pizza.class);
    ...
    public void putListObject(String key, ArrayList<Pizza> playerList){
        checkForNullKey(key);
        Gson gson = new Gson();
        ArrayList<String> objStrings = new ArrayList<String>();
        for(Pizza player: playerList){
